...
from baselines.graspers.grconvnet.network.hardware.camera import RealSenseCamera
...
from baselines.graspers.grconvnet.network.utils.dataset_processing.grasp import detect_grasps
from baselines.graspers.grconvnet.network.utils.visualisation.plot import plot_grasp
...
class GraspGenerator:
    ...
    def generate(self):
        ...
        q_img, ang_img, width_img = self.predict(rgb, depth)
